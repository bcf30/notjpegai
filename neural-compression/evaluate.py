...
def evaluate_neural(
    ...
    with torch.no_grad():
        for path in image_paths:
            ...
            # Decompress using the authoritative latent-z shape returned by
            # CompressAI (same value compress.py/decompress.py persist and use).
            recon = codec.model.decompress(out["strings"], out["shape"])
