...
graph_metrics.py: graph-topology based evaluation for image accuracy with focus on ringing artifacts
...
## Evaluate: compare original vs newly-compressed image
